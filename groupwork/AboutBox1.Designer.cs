namespace groupwork
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "产品名称:刷卡系统";
            ...
            this.labelVersion.Text = "版本号:alpha1";
            ...
            this.labelCopyright.Text = "版权声明:打扰了";
            ...
            this.labelCompanyName.Text = "制作方:顾国风全国后援会";
            ...
            this.textBoxDescription.Text = "设计缺陷\r\n1.查询账号密码通过视图完成，视图建立前无法判断是否已存在此视图。\r\n2.学生教师考勤查询只有当学年信息\r\n3.学生界面打开时无法直接显示数据库内容\t" +
    "\r\n4.Admin下第三个标签页变量命名不规范\r\n5.未添加选课管理页面，选课只能从数据库手动添加\r\n6.刷卡成功记录弹窗无法自动关闭，需要手动点击确定关闭\r\n" +
    "\r\n";
